...
class PaymentWaitingPage extends StatelessWidget {
  ...
  AssetGenImage? _getBankIconAsset(String? bankCode) {
    ...
    switch (bankCode.toLowerCase()) {
      ...
      case 'bri':
        return Assets.images.banks.bRIDirectDebit;
      case 'bni':
        ...
        builder: (context, state) {
          ...
          switch (state) {
            case DoOrderLoaded loadedState:
              ...
              // --- PERBAIKAN: Menghapus .toJson() untuk debugging jika Order tidak memilikinya ---
              debugPrint(
          ...
          // --- PERBAIKAN: Pindahkan pengecekan orderData == null ke sini ---
          // Hanya lanjutkan untuk membangun ListView jika orderData tidak null.
          // Ini lebih aman daripada fallback check setelah switch.
          if (orderData == null) {
            debugPrint(
                'PaymentWaitingPage - orderData is null before building ListView. State was: $state');
            // Ini bisa terjadi jika state DoOrderLoaded, tapi orderData di dalamnya null.
            // UI error untuk kasus ini sudah ditangani di dalam case DoOrderLoaded.
            // Jika state bukan DoOrderLoaded, UI loading/error sudah dikembalikan.
            // Jadi, jika sampai sini dan orderData null, itu adalah kondisi yang tidak diharapkan
            // jika state adalah DoOrderLoaded.
            return const Center(
              child: Column(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                      ...
                      children: [
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              Text(
                                // Menggunakan orderData langsung karena sudah divalidasi tidak null
          ...
          children: [
            ...
            Button.outlined(
              onPressed: () {
                ...
                // Menggunakan orderIdForNav yang di-set di scope BlocBuilder
